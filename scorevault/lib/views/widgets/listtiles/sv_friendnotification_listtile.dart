...
class SvFriendnotificationListtile extends StatelessWidget {
  final ModelUser user;
  const SvFriendnotificationListtile({super.key, required this.user});
                ...
                children: [
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        context.read<AuthProvider>().rejectFriendRequest(
                          user.getUid,
                        );
                      },
                    ),
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        context.read<AuthProvider>().acceptFriendRequest(
                          user.getUid,
                        );
                      },
                    ),
